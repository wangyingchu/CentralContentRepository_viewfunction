...
public class TestCaseDataConstant {
	public static final String testContentSpaceName="testNG_TestContentSpace";
	public static final String testRootContentObjectName="testNG_TestRootContentObject";
